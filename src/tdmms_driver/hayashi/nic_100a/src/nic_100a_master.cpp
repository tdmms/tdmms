...
class nic_100a_master {
 public:
  nic_100a_master() {
    ros::NodeHandle node;
    cmd_on_sub_ = node.subscribe("/nic_100a/cmd_on", 1,
                                 &nic_100a_master::cmd_on_Callback, this);
    cmd_off_sub_ = node.subscribe("/nic_100a/cmd_off", 1,
                                  &nic_100a_master::cmd_off_Callback, this);
    cmd_inten_ = node.subscribe("nic_100a/cmd_inten", 1,
                                &nic_100a_master::cmd_inten_Callback, this);
