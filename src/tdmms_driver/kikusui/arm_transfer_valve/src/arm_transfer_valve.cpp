...
class transfer_valve_master{
 ...
 transfer_valve_master() {
    ...
    strDelimiter = "\r\n";
    parameter_name = "/arm_transfer_valve/ipaddr";
    ...
    parameter_name = "/arm_transfer_valve/ipport";
...
int main(int argc, char *argv[]) {
  ros::init(argc, argv, "arm_transfer_valve");
