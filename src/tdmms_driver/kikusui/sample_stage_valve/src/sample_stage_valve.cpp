...
class transfer_valve_master{
 ...
 transfer_valve_master() {
    ...
    strDelimiter = "\r\n";
    parameter_name = "/sample_stage_valve/ipaddr";
    ...
    parameter_name = "/sample_stage_valve/ipport";
...
int main(int argc, char *argv[]) {
  ros::init(argc, argv, "sample_stage_valve");
