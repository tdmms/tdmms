...
class autostamp_flake_aligner_xytheta5x3_class {
 protected:
  ...
  tdmms_autostamp_flake_aligner_xytheta5x3_action::AlignFlakeXYTheta5x3Feedback
      feedback_;
  tdmms_autostamp_flake_aligner_xytheta5x3_action::AlignFlakeXYTheta5x3Result
      result_;
 ...
 public:
  autostamp_flake_aligner_xytheta5x3_class(std::string name)
      : as_(node_, name,
            boost::bind(
                &autostamp_flake_aligner_xytheta5x3_class::executeAlignFlake,
                this, _1),
            false),
        action_name_(name) {
  ...
  ~autostamp_flake_aligner_xytheta5x3_class(void) {}
  ...
  void executeAlignFlake(const tdmms_autostamp_flake_aligner_xytheta5x3_action::
                             AlignFlakeXYTheta5x3GoalConstPtr &goalparam) {
    bool success = true;
    openWindows();
    ///////////////////////////////////
    ...
    image_subscriber_main = node_.subscribe(
        ...
        &autostamp_flake_aligner_xytheta5x3_class::imageStreamCallback, this);
...
int main(int argc, char **argv) {
  ...
  ros::init(argc, argv, "tdmms_autostamp_flake_aligner_xytheta5x3_action");
  autostamp_flake_aligner_xytheta5x3_class flake_aligner(
