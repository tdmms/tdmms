...
class autostamp_flake_aligner_xytheta5x_class {
 protected:
  ...
  tdmms_autostamp_flake_aligner_xytheta5x_action::AlignFlakeXYTheta5xFeedback
      feedback_;
  tdmms_autostamp_flake_aligner_xytheta5x_action::AlignFlakeXYTheta5xResult
      result_;
 ...
 public:
  autostamp_flake_aligner_xytheta5x_class(std::string name)
      : as_(node_, name,
            boost::bind(
                &autostamp_flake_aligner_xytheta5x_class::executeAlignFlake,
                this, _1),
            false),
        action_name_(name) {
  ...
  ~autostamp_flake_aligner_xytheta5x_class(void) {}
  ...
  void executeAlignFlake(const tdmms_autostamp_flake_aligner_xytheta5x_action::
                             AlignFlakeXYTheta5xGoalConstPtr &goalparam) {
    bool success = true;
    openWindows();
    ///////////////////////////////////
    ...
    image_subscriber_main = node_.subscribe(
        ...
        &autostamp_flake_aligner_xytheta5x_class::imageStreamCallback, this);
...
int main(int argc, char **argv) {
  ros::init(argc, argv, "tdmms_autostamp_flake_aligner_xytheta5x_action");
  autostamp_flake_aligner_xytheta5x_class flake_aligner(
