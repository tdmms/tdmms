...
class autostamp_flake_positioner_fast2_class {
 protected:
  ...
  tdmms_autostamp_flake_positioner_action_fast2::PositionFlakeFast2Feedback
      feedback_;
  tdmms_autostamp_flake_positioner_action_fast2::PositionFlakeFast2Result result_;
 ...
 public:
  explicit autostamp_flake_positioner_fast2_class(std::string name)
      : as_(node_, name,
            boost::bind(
                &autostamp_flake_positioner_fast2_class::executePositionFlake,
                this, _1),
            false),
        action_name_(name) {
  ...
  ~autostamp_flake_positioner_fast2_class(void) { db.close(); }
  ...
  void executePositionFlake(const tdmms_autostamp_flake_positioner_action_fast2::
                                PositionFlakeFast2GoalConstPtr &goalparam) {
    bool success = true;
    //    as_.acceptNewGoal();
    ...
    image_subscriber_main = node_.subscribe(
        ...
        &autostamp_flake_positioner_fast2_class::imageStreamCallback, this);
...
int main(int argc, char **argv) {
  ...
  ros::init(argc, argv, "tdmms_autostamp_flake_positioner_action_fast2");
  autostamp_flake_positioner_fast2_class flake_positioner(
