...
#include <QMessageBox>
#include <iostream>
#include "../include/tdmms_transfer_master/main_window.hpp"
...
MainWindow::MainWindow(int argc, char **argv, QWidget *parent)
  ...
  QObject::connect(ui.pushButton_DIO, SIGNAL(clicked(bool)), &qnode,
                   SLOT(on_DIO_clicked(bool)));
  QObject::connect(ui.pushButton_right_open, SIGNAL(clicked(bool)), &qnode,
                   SLOT(on_right_open_clicked(bool)));
  QObject::connect(ui.pushButton_right_close, SIGNAL(clicked(bool)), &qnode,
                   SLOT(on_right_close_clicked(bool)));
  QObject::connect(ui.pushButton_right_grip, SIGNAL(clicked(bool)), &qnode,
                   SLOT(on_right_grip_clicked(bool)));
  QObject::connect(ui.pushButton_left_open, SIGNAL(clicked(bool)), &qnode,
                   SLOT(on_left_open_clicked(bool)));
  QObject::connect(ui.pushButton_left_grip, SIGNAL(clicked(bool)), &qnode,
                   SLOT(on_left_grip_clicked(bool)));
  QObject::connect(ui.pushButton_left_close, SIGNAL(clicked(bool)), &qnode,
                   SLOT(on_left_close_clicked(bool)));
  QObject::connect(ui.pushButton_Chuck, SIGNAL(clicked(bool)), &qnode,
                   SLOT(on_Chuck_clicked(bool)));
  qnode.pushButton_Chuck = ui.pushButton_Chuck;
  /*********************
  ** Logging
  **********************/
...
void MainWindow::ReadSettings() {
  QSettings settings("Qt-Ros Package", "tdmms_transfer_master");
